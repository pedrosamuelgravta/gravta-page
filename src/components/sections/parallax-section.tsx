...
export function ParallaxSection() {
  return (
    <section className="w-full h-screen col-span-full max-sm:col-span-full">
      <div className="w-full my-30 max-sm:my-10 max-sm:mt-0 flex flex-row justify-between gap-10 lg:gap-0">
        {/* Container with sticky effect */}
        ...
        <aside className="flex flex-col gap-32 mt-29 justify-center w-full">
