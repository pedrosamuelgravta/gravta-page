...
export function App() {
  ...
  useEffect(() => {
    ...
    function updateBodyHeight() {
      if (contentRef.current) {
        ...
        document.body.style.height = `${contentHeight + 70}px`; // 120px = navbar + footer
      }
    }
    ...
    function raf(time: any) {
      ...
      if (contentRef.current) {
        ...
        const maxScroll =
          ...
          (windowHeight - 70); // Limita o scroll
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch(
        "http://adneura-backend-uchgev-7c1142-194-195-86-246.traefik.me/contact",
        {
          method: "POST",
  ...
  return (
    <main>
      ...
      {showFooter && <Navbar />}
      <div className="fixed top-[40px] left-0 right-0 lg:mx-10 xl:mx-20 mx-4 max-h-[calc(100vh-70px)] overflow-hidden z-10">
        <div
          ref={contentRef}
        ...
        >
          ...
          <section className="w-full h-full justify-center items-center col-start-2 col-end-9 max-sm:col-span-full flex flex-col gap-20">
            <div className="flex flex-row justify-between w-full items-start max-sm:items-start my-30 max-sm:flex-col max-sm:my-10 max-sm:gap-10 max-sm:mt-0">
              <MaskText
                phrases={[
                  "Gravta operates",
                  "at the intersection",
                ...
                className="text-[3vw] max-sm:text-4xl text-white font-medium leading-[110%]"
              />
              <div className="flex flex-col gap-10 max-sm:gap-0 max-sm:flex-col">
          ...
          <section className="w-full h-full col-span-full">
            <div className="flex flex-col gap-10 justify-start items-end my-20 max-sm:mt-0">
              <MaskText
          ...
          <section className="w-full h-full col-span-full">
            <div className="flex flex-col gap-10 justify-start items-end my-30 max-sm:my-0">
